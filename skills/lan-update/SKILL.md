...
1. 跑更新脚本（它自带 clone-or-pull 判断，装没装过都能跑）：
...
| 新增的 skill 更新后没被链接进 skills 目录 | 更新后强制重刷 install（幂等重建链接） | update.sh 末行 / 步骤 3 |
| 更新了什么用户不知道 | git log 摘要翻成白话汇报 | 步骤 4 |
